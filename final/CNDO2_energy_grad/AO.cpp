...
Atom GenerateAtom(std::string atomname, std::string basis_dir, arma::vec R0)
{
  std::string basisname = basis_dir + atomname + "_STO3G.txt";
  arma::mat basis;
...
Molecule_basis::Molecule_basis(string &fname, std::string &basis_dir)
{
  ...
  while (getline(in, line))
  {
    ...
    Atom readAtom = GenerateAtom(atomname, basis_dir, R0);
